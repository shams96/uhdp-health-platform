...
export default function Home() {
  return (
    <div>
      <Head>
        <title>UHDP - Universal Health Data Platform</title>
        <meta name="description" content="Monitor and analyze polio vaccination integration with other essential health services" />
          ...
          <div className="container mx-auto px-4 py-16 text-white">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/dashboard">
                  <a className="bg-white text-primary-600 hover:bg-gray-100 font-semibold py-2 px-4 rounded-md transition-colors">Learn More</a>
                </Link>
              </div>
            </div>
          </div>
